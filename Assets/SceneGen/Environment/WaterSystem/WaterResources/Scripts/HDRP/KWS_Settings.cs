...
namespace KWS
{
    public static class KWS_Settings
    {
        public static class Water
        {
            ...
            public static readonly int   WaterLayer                = 4; //water layer
        ...
        {
            public static readonly float MaxSunStrength = 15;
        }
        ...
        {
            public static readonly Dictionary<WaterSystem.WaterProfileEnum, Dictionary<string, object>> VolumetricLightProfile = new Dictionary<WaterSystem.WaterProfileEnum, Dictionary<string, object>>
            {
                {
                    WaterSystem.WaterProfileEnum.Ultra, new Dictionary<string, object>
                    {
                        { "VolumetricLightResolutionQuality", WaterSystem.VolumetricLightResolutionQualityEnum.Ultra},
                        { "VolumetricLightIteration", 8},
                        { "VolumetricLightFilter",  WaterSystem.VolumetricLightFilterEnum.Bilateral }
                    }
                },
                {
                    WaterSystem.WaterProfileEnum.High, new Dictionary<string, object>
                    {
                        { "VolumetricLightResolutionQuality", WaterSystem.VolumetricLightResolutionQualityEnum.High},
                        { "VolumetricLightIteration", 6},
                        { "VolumetricLightFilter",  WaterSystem.VolumetricLightFilterEnum.Bilateral }
                    }
                },
                {
                    WaterSystem.WaterProfileEnum.Medium, new Dictionary<string, object>
                    {
                        { "VolumetricLightResolutionQuality", WaterSystem.VolumetricLightResolutionQualityEnum.Medium},
                        { "VolumetricLightIteration", 4},
                        { "VolumetricLightFilter",  WaterSystem.VolumetricLightFilterEnum.Bilateral }
                    }
                },
                {
                    WaterSystem.WaterProfileEnum.Low, new Dictionary<string, object>
                    {
                        { "VolumetricLightResolutionQuality", WaterSystem.VolumetricLightResolutionQualityEnum.Low},
                        { "VolumetricLightIteration", 3},
                        { "VolumetricLightFilter",  WaterSystem.VolumetricLightFilterEnum.Bilateral },
                        { "VolumetricLightBlurRadius",  2f }
                    }
                },
                {
                    WaterSystem.WaterProfileEnum.PotatoPC, new Dictionary<string, object>
                    {
                        { "VolumetricLightResolutionQuality", WaterSystem.VolumetricLightResolutionQualityEnum.VeryLow},
                        { "VolumetricLightIteration", 2},
                        { "VolumetricLightFilter",  WaterSystem.VolumetricLightFilterEnum.Gaussian },
                        { "VolumetricLightBlurRadius",  3.5f }
                    }
                },
            };
