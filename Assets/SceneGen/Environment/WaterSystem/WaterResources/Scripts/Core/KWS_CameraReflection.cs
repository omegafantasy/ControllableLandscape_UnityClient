...
namespace KWS
{
    ...
    public partial class KWS_CameraReflection : MonoBehaviour
    {
        ...
        private bool _lastUsePlanarCubemapReflection;
        ...
        void UpdateWaterLocalVariables()
        {
            ...
            _lastUsePlanarCubemapReflection = WaterInstance.UsePlanarCubemapReflection;
        ...
        public void RenderPlanar(Camera currentCamera, Vector3 waterPosition)
        {
            ...
            if (WaterInstance.UseAnisotropicReflections) RenderAnisotropicBlur(_planarRT, _planarRT_MipOrFiltered, false);
        ...
        void RenderAnisotropicBlur(RenderTexture sourceRT, RenderTexture targetFilteredRT, bool isCubemap, CubemapFace face = CubemapFace.Unknown)
        {
            if (_filteringMaterial == null) _filteringMaterial = KWS_CoreUtils.CreateMaterial(KWS_ShaderConstants.ShaderNames.ReflectionFiltering);
            ...
            if (isCubemap)
            {
                ...
                float isCubemapSide = 0;
                if (face == CubemapFace.NegativeX || face == CubemapFace.NegativeZ || face == CubemapFace.PositiveX || face == CubemapFace.PositiveZ) isCubemapSide = 1;
        ...
        bool IsRequireUpdateAllSides(Camera cam)
        {
            return (_cubemapRT_Side == null || !_cubemapRTBuffers.ContainsKey(cam) ||
                 ...
                 || WaterInstance.UsePlanarCubemapReflection != _lastUsePlanarCubemapReflection);
        }
        ...
        public void RenderCubemap(Camera currentCamera, Vector3 waterPosition, float interval, int cullingMask, bool UsePlanarCubemapReflection)
        {
            ...
            WaterInstance.SetFloats((KWS_ShaderConstants.ReflectionsID.KWS_IsCubemapReflectionPlanar, UsePlanarCubemapReflection ? 1 : 0));
        ...
        void RenderToCubemapFace(RenderTexture targetCubemap, Camera currentCamera, Vector3 waterPosition, CubemapFace face, Matrix4x4 projectionMatrix, bool UsePlanarCubemapReflection)
        {
            ...
            if (WaterInstance.UseAnisotropicReflections) RenderAnisotropicBlur(_cubemapRT_Side, _cubemapRT_SideFiltered, true, face);
